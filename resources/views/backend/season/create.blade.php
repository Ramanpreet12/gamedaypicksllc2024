...
@section('subcontent')
    <div class="intro-y box mt-5">
        ...
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            <h2 class="font-medium text-base mr-auto">Add Season </h2>
            ...
            <div id="horizontal-form" class="p-5">
                <div class="preview  mr-5">
                    <div class="form-inline">
                        ...
                        <input id="name" type="text" class="form-control" placeholder="Name" name="season_name" value="{{old('season_name')}}">
                    </div>
                    ...
                    <div class="form-inline mt-5">
                        ...
                        <input id="start_date" type="date" class="form-control" placeholder="Start date" name="starting"value="{{old('starting')}}">
                    </div>
                    <div class="form-inline mt-2">
                        <label for="" class="font-medium form-label sm:w-60"></label>
                        @error('starting')<p class="text-danger">{{$message}}</p> @enderror
                    </div>

                    <div class="form-inline mt-5">
                        <label for="end_date" class="font-medium form-label sm:w-60">End Date <span class="text-danger">*</span></label>
                        <input id="end_date" type="date" class="form-control" placeholder="End date" name="ending" value="{{old('ending')}}">
                    </div>
                    <div class="form-inline mt-2">
                        <label for="" class="font-medium form-label sm:w-60"></label>
