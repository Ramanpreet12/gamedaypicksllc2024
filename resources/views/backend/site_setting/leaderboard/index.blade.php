                    ...
                    <div id="horizontal-form" class="px-3 flex">
                        ...
                        <div class="preview mx-3">
                            <div class="form-inline">
                                ...
                                @if (!empty($leaderHeading->value))
                                value="{{$leaderHeading->value}}"
                                @else
                                value=""
                                @endif>
                            </div>
                ...
                <tbody>
                    @forelse ($players as $player)
                        <tr class="intro-x">
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        ...
                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('storage/images/team_logo/'.$player->teams->logo)}}" title="">
                                        @else
                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('dist/images/no-image.png')}}" title="">
                                        @endif
                                    </div>
                            ...
                            <td class="text-center">{{$player->teams->region ?? ''}}</td>
