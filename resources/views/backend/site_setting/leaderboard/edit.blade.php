...
@section('subcontent')
    ...
    <div class="grid grid-cols-6 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form action="{{ url('admin/leaderboard/edit/'.$leaderboard->id) }}" method="post">
                @csrf
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <select data-placeholder="Select Team" class="tom-select w-full" id="region" name="region">
                            <option value="">--select--</option>
                            <option value="north" {{$leaderboard->region=='north' ? 'selected' : ''}}>North</option>
                    ...
                    <div class="mt-3">
                        ...
                        <select data-placeholder="Select your favorite actors" class="tom-select w-full" id="teams"
                            ...
                            @foreach ($teams as $team)
                                <option value="{{ $team->id }}"{{$leaderboard->team_id == $team->id ? 'selected' : ''}}>{{ $team->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('teams')
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="win" type="text" class="form-control" placeholder="win" value="{{$leaderboard->win}}"
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="loss" type="text" class="form-control" placeholder="loss"  value="{{$leaderboard->loss}}"
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="pts" type="text" class="form-control" placeholder="pts"  value="{{$leaderboard->pts}}"
                            ...
                            <div class="sm:grid grid-cols-2 gap-2">
                                <div class="input-group mt-2 sm:mt-0">
                                    <select class="form-select w-full" id="status" name="status">
                                        <option value="">--select--</option>
                                        <option value="active" {{$leaderboard->status == 'active' ? 'selected' : ''}}>Active</option>
                                        <option value="inactive" {{$leaderboard->status == 'inactive' ? 'selected' : ''}}>Inactive</option>
                                    </select>
                                </div>
                            </div>
