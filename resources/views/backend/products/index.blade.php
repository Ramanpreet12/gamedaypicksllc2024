...
@section('subhead')
    <title>{{ $general->name ? $general->name : 'NFL' }} | Products</title>
@endsection
...
@section('subcontent')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a class="btn btn-primary shadow-md mr-2" href="{{ route('shop.create') }}" id="add_banner">Add New
                Product</a>
        </div>
    </div>
            ...
            <table class="table table-report -mt-2" id="product_table">
                <thead class="bg-primary text-white">
                    <tr>
                        ...
                        {{-- <th class="text-center whitespace-nowrap">Store Type</th> --}}
                    ...
                    @if ($get_products->isNotEmpty())
                        @foreach ($get_products as $product)
                            <tr class="intro-x">
                                ...
                                {{-- <td class="text-center">{{ $product->store_type }}</td> --}}
                                ...
                                <td class="table-report__action">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="{{ route('shop.edit', $product->id) }}">
                                        ...
                                        <a data-toggle="tooltip" title="Delete">
                                            <button class="btn btn-danger confirmDelete" data-toggle="tooltip"
                                                title="Delete" module="products/shop" module_id={{ $product->id }}>
