...
@endif
    ...
    <div class="intro-y box mt-5">
        ...
        <form action="{{ route('greek-store.update', $product->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                    ...
                    <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <input id="product_url" type="text" class="form-control input w-full border flex-1"
                            placeholder="Product URL" name="product_url"
                    ...
                    <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <input id="university_sale_text" type="text" class="form-control input w-full border flex-1"
                            placeholder="e.g. 10% of the sale goes back to the University" name="university_sale_text" value="{{ old('university_sale_text' , $product->university_sale_text) }}">
...
{{--
                    <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <input id="sale_goes_back_to_university" type="text" class="form-control input w-full border flex-1"
                            placeholder="e.g. 10% , 20% etc..." name="sale_goes_back_to_university" value="{{ old('sale_goes_back_to_university',$product->sale_goes_back_to_university) }}">
                                            ...
                                            <div class="w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
                                                ...
                                                <div title="Remove this image?" style="background: red"
                                                    ...
                                                    <i data-feather="x" class="w-4 h-4 confirmDelete"
                                                        title="Delete Image" module="products/greek-store-image"
                ...
                <div class="border border-gray-200 rounded-md p-5 mt-5">
                    ...
                    <div
                        ...
                        <h2 class="font-medium text-base mr-auto">Greek Store Variations </h2>
                        <a href="{{ url('admin/products/greek-store/add-variants/'.$product->id) }}" class="btn btn-primary">
                         Add Variants</a>
                                                    ...
                                                    <td class="table-report__action w-56">
                                                            <div class="flex justify-center items-center">
                                                                <a class="flex items-center mr-3"
                                                                    href="{{ url('admin/products/greek-store/'.$product->id.'/edit-variants/'.$product_variation->id) }}">
                                                                ...
                                                                title="Delete" module="products/greek-store-variation" module_id={{ $product_variation->id }}>
