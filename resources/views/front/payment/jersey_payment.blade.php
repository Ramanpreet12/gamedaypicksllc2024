                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="billingInfo">
                                    ...
                                    <form action="{{ route('place_order') }}" method="post" id="payment-form">
                                        @csrf
                                         ...
                                         @endphp
                                         <?php $total = 0; ?>
                                         {{-- @foreach (session('buy_now_session') as $id => $product_details) --}}
                                         <?php $total += $get_buy_now_session['product_price'] * $get_buy_now_session['product_qty']; ?>
                                         {{-- @endforeach --}}
                                      {{-- {{   dd(session()->get('buy_now_session'))}} --}}
