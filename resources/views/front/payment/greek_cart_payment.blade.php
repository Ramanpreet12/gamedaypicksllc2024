                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="billingInfo">
                                    ...
                                    <form action="{{ url('proceed_to_checkout_from_greek_cart') }}" method="post"
                                        id="payment-form">
                                        @csrf
                                        ...
                                        @if (session()->has('GreekshoppingCart'))
                                            @if (!empty(session()->get('GreekshoppingCart')))
                                                @php
                                                    $get_shoppingCart_session = session()->get('GreekshoppingCart');
                                                @endphp
                                                <?php $cart_total = 0; ?>
                                                @foreach ($get_shoppingCart_session as $id => $product_details)
                                                    <?php $cart_total += $product_details['product_price'] * $product_details['product_qty']; ?>
                                                @endforeach

                                                <input type="hidden" name="amount" id="amount"
                                                    value="{{ $cart_total }}" readonly>
                                            @endif
                                        @endif



                                        {{-- <input type="hidden" name="admin_jersey_id" id="admin_jersey_id" value="{{ $jersey_id }}" readonly> --}}
                                        ...
                                        <a onclick="history.back()" type="button" class="btn btn-primary mt-3">Return
                                            Back
                                        </a>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" id="clover__form">
                                ...
                                <div class="form-row top-row ">
                                    <div id="amount" class="field card-number">
                                        {{-- <input type="text" name="amount" placeholder="Amount" class="form-control" value="{{ $get_cart_total_amount }}" readonly> --}}
                                    </div>
                                </div>
