            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-12 col-lg-8 col-md-12">
                    <div class="loginFormSubmit">
                        <div class="row">
                            <div class="textHeader mb-3 text-center">
                                <h2>Payment Information</h2>
                            </div>
                            <div class="text-center">
                                @if (session('message_error'))
                                    <div class="alert alert-danger show flex items-center mb-5" role="alert">
                            ...
                            <div class="col-sm-6">
                                <div class="billingInfo">
                                    ...
                                    {{-- <form action="{{ url('buy_jersey/'.$get_order->id) }}" method="post" id="payment-form"> --}}
                                    <form action="{{ route('place_order_for_greek_product') }}" method="post"
                                        id="payment-form">
                                        @csrf

                                        {{-- <input type="hidden" name="order_id" id="order_id" value="{{ $get_order->id }}" readonly> --}}
                                        <input type="text" name="user_id" id="user_id" value="{{ Auth::user()->id }}"
                                            readonly>

                                        @if (session()->has('greek_buy_now_session'))
                                            @if (!empty(session()->get('greek_buy_now_session')))
                                                @php
                                                    $get_greek_buy_now_session = session()->get('greek_buy_now_session');
                                                    //  dd( $get_buy_now_session);
                                                @endphp
                                                <?php $total = 0; ?>
                                                <?php $total += $get_greek_buy_now_session['greek_product_price'] * $get_greek_buy_now_session['greek_product_qty']; ?>
                                        ...
                                        <div class="input-errors pt-1" id="country-error" role="alert"></div>
                                        <a type="button" onclick="history.back()" class="btn btn-primary">Return Back
                                        </a>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" id="clover__form">
                                ...
                                <div class="form-row top-row ">
                                    <div id="amount" class="field card-number">
                                        {{-- <input type="hidden" name="amount" placeholder="Amount" class="form-control" value="{{ $get_order->total_amount }}" readonly> --}}
                                    </div>
                                </div>

                                <div class="form-row top-row">
                                    <label for="country" class="form-label">Card Number <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-row">
                                    <label for="country" class="form-label">Card Expiry Date <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-row">
                                    <label for="country" class="form-label">CVV number <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-row">
                                    <label for="country" class="form-label">Postal Code <span
                                            class="text-danger">*</span></label>
...
@section('script')
    ...
    <script>
        ...
        cardPostalCode.addEventListener('change', function(event) {
            ...
            displayCardPostalCodeError.title = displayCardPostalCodeError.innerHTML = event.CARD_POSTAL_CODE
                .error || '';
        });
