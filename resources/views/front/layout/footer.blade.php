                ...
                <div class="contactDetail">
                    ...
                    @if ($general->santa_game_store && $general->santa_game_store_link)
                        <div class="contactUs d-flex">
                            ...
                            <div><span><a href="{{ $general->santa_game_store_link }}"
                                        style="color:{{ $general->santa_game_store_color }}; text-decoration:none;">{{ $general->santa_game_store }}</a></span>
                    ...
                    <div class="footerIcon">
                        ...
                        @if (!empty($social_links))
                            ...
                            @if ($social_links['Pinterest'] != '')
                                <a href="{{ $social_links['Pinterest'] }}" target="_blank"> <i
...
<!--lightslider.js--------------->
<script type="text/javascript" src="{{ asset('front/lightslider/dist/js/lightslider.js') }}"></script>
...
<script src="{{ asset('front/js/marquee/gistfile1.js') }}"></script>
<style type="text/css">
    #footerPart {
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#men').click(function() {
            $('.men_sizes').show();
            $('.women_sizes , .youth_sizes').hide();
        });

        $('#women').click(function() {
            $('.women_sizes').show();
            $('.men_sizes , .youth_sizes').hide();
        });

        $('#youth').click(function() {
            $('.youth_sizes').show();
            $('.women_sizes , .men_sizes').hide();
        });
...
<script>
    ...
    var errorMap = ["Please enter the valid number", "Invalid country code", "The phone number is Too short",
        "The phone number is Too long", "Please enter the valid number"
    ];
