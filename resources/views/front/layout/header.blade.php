@if (!$general->announcement_bar == null)
    <div
        style="background:{{ $general->header_announcement_bar_bg_color ? $general->header_announcement_bar_bg_color : '#DA9A29' }}; color:{{ $general->header_announcement_bar_text_color ? $general->header_announcement_bar_text_color : '#fff' }}; padding:10px 0; font-size:17px;">
            ...
            <ul class="navbar-nav ms-auto me-auto  mb-2 mb-lg-0 main-menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle"
                        ...
                        {{-- @if (Auth::user() && Auth::user()->age = 'NULL' && Auth::user()->role_as == 1)
                    href="{{ route('shop') }}"
                    @elseif(Auth::user() && Auth::user()->age <= config('app.youth_age_limit') && Auth::user()->role_as == 0) 
                    href="{{ route('pony-express-flag-football-shop') }}"
                    
                    @else
                    href="{{ route('shop') }}" @endif --}}
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto me-auto  mb-2 mb-lg-0 main-menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link"  @if (Auth::user() && Auth::user()->age <= config('app.youth_age_limit')) href="{{ route('pony-express-flag-football-shop') }}"
                        @else
                        href="{{ route('shop') }}" @endif style="color:#f6f4f4"> Shop<span class="navHoverEffect"> </span></a>
                    <span type="button" class="dropdown-toggle" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false"><span class="visually-hidden">Dropdown</span></span>

                    <div class="dropdown-menu megaMenu" x-placement="bottom-start"
                        style="position: absolute; background-color:#da9a29;" data-bs-popper="static">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <ul class="navbar-nav dropList">
                                    ...
                                    <li class="nav-item"> <a class="dropdown-item"
                                            href="{{ route('greek-store') }}">Greek Store</a></li>
