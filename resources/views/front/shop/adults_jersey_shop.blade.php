                    ...
                    if(response.length > 0){
                        ...
                        for(i=0;i<response.length;i++){
                            ...
                            if (response[i]['product_variations'].length > 0) {
                              $("#tabcontentmainDiv").append('<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3"><div class="products-single fix"><div class="box-img-hover"><a href="'+base_url+'/shop/'+product_url+'"><img src="'+base_url+'/storage/images/products/'+image_name+'" class="img-fluid" alt="Image"></a></div><div class="why-text"><span>'+response[i]['product_name']+'</span><h5>$'+response[i]['product_variations'][0]['product_price']+'</h5></div></div></div>');
                            //   $("#tabcontentmainDiv").append('<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3"><div class="products-single fix"><div class="box-img-hover"><a href="'+base_url+'/shop/'+product_url+'/'+product_id+'"><img src="'+base_url+'/storage/images/products/'+image_name+'" class="img-fluid" alt="Image"></a></div><div class="why-text"><span>'+response[i]['product_name']+'</span><h5>$'+response[i]['product_variations'][0]['product_price']+'</h5></div></div></div>');
