...
return [
    ...
    */
    ...
    'channels' => [
        ...
        // unsuceesfull payment logging file
        'payment' => [
            'driver' => 'single',
        ...
        'jersey_payment_successfull' => [
         ...
         // greek_payment_success logging file
         'greek_payment_success' => [
            'driver' => 'single',
            'path' => storage_path('logs/greek_payment_success.log'),
            'level' => 'info',
        ],


         // greek_payment_failed logging file
         'greek_payment_failed' => [
            'driver' => 'single',
            'path' => storage_path('logs/greek_payment_failed.log'),
            'level' => 'info',
        ],
