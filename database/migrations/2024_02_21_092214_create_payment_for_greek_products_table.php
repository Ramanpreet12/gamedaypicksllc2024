...
class CreatePaymentForGreekProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('payment_for_greek_products', function (Blueprint $table) {
            $table->id();
            $table->integer('user_id');
            $table->integer('greek_order_id');
    ...
    {
        Schema::dropIfExists('payment_for_greek_products');
    }
}
