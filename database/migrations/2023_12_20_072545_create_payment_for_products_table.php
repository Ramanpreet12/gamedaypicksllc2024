...
class CreatePaymentForProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('payment_for_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('payment_for_products');
    }
}
